...
document.querySelector(".freedom-genre").addEventListener("click", () => {
    updateGenre("Freedom");
});

document.querySelector(".history-genre").addEventListener("click", () => {
    updateGenre("History");
});

document.querySelector(".wisdom-genre").addEventListener("click", () => {
    updateGenre("Wisdom");
});

document.querySelector(".tech-genre").addEventListener("click", () => {
    updateGenre("Technology");
});

document.querySelector(".humorous-genre").addEventListener("click", () => {
    updateGenre("Humorous");
});
